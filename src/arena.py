...
def create_mission(agent_names, num_agents, trackw=TRACK_WIDTH, trackb=TRACK_BREADTH, trackh=TRACK_HEIGHT, timelimit=TIMELIMIT):
    ...
    for i in range(num_agents):
        ...
        <AgentStart>
          ...
          '''
        weapon = random.randint(0,1)
        WEAPON_MAPPING[agent_names[i]] = weapon
        if(weapon == 0):
            missionXML += '''
